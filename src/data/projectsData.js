...
export const projects = [
    ...
    image: "assets/project/project_two.png",
    galleryImages: [],
  ...
  },
  {
    ...
    image: "assets/project/project_new.png", // Main project image
  ...
  },
  {
    ...
    image: "assets/project/project_tree.png",
    galleryImages: [],
    ...
    image: "assets/project/project_four.png",
    galleryImages: [],
    cardBackground: "linear-gradient(135deg, #232526 0%, #414345 100%)",
    textColor: "#ffffff",
    accentColor: "#00d9ff",
  },
   {
    ...
    image: "assets/project/project_five.png",
    galleryImages: [],
    cardBackground: "linear-gradient(135deg, #232526 0%, #414345 100%)",
    textColor: "#ffffff",
    accentColor: "#00d9ff",
    ...
    image: "assets/project/project_six.png",
    galleryImages: [],
    cardBackground: "linear-gradient(135deg, #232526 0%, #414345 100%)",
    textColor: "#ffffff",
    accentColor: "#00d9ff",
  },
  {
    ...
    image: "assets/project/project_seven.png",
    galleryImages: [],
    cardBackground: "linear-gradient(135deg, #232526 0%, #414345 100%)",
    textColor: "#ffffff",
    accentColor: "#00d9ff",
